...
#         if not HUME_API_KEY or not HUME_SECRET_KEY or not HUME_CONFIG_ID:
...
#         print("Initializing client and connecting to WebSocket...")
...
#         print("Starting microphone and message sending tasks...")
