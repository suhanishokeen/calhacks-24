...
const MoodOverview = ({ loggedDays }) => {
  ...
  return (
    <div className="p-6 rounded-lg transition duration-300 ease-in-out transform hover:scale-105 bg-[#234759]">
      <h4 className="font-bold text-lg text-white">Mood Logging Overview</h4>
      <p className="text-white">You've logged your mood on {loggedDays} out of {totalDays} days.</p>
